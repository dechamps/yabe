...
//		10/11/2017
//			-SelectedNode property do not trow exception : it's the 
//			last mouse & keyboard selected TreeNode  
// *****************************************************************************
...
namespace CodersLab.Windows.Controls
{
	...
	/// </summary>
	[ToolboxItem(true)]
    [System.ComponentModel.DesignerCategory("")] // Avoid opening with the GUI Designer
	public class TreeView : System.Windows.Forms.TreeView
	{
        ...
        /// ... back in usage into Yabe code : last selected item
		/// </summary>
        /// 
		...
		protected override void OnKeyDown(KeyEventArgs e)
		{
			...
			{
                LastSelectedNode = tnNewlySelectedNodeWithKeys;
